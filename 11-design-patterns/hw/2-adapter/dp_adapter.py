...
class Adapter(DocumentsHandler):
    def __init__(self, adaptee):
        self._service = adaptee._service
        self._document_ids = adaptee._document_ids
    ...
    def get_documents(self, document_ids):
        ...
        for pos, document in enumerate(loaded_documents):
            if document.endswith('.json'):
                loaded_documents[pos] = document.replace('.json', '.xml')
